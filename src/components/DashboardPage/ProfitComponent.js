...
<section class="px-4 py-4 mx-8 max-w-7xl">
<h2 class="text-xl font-semibold text-gray-900">Profit Overview</h2>
  <div class="grid grid-cols-1 gap-5 md:grid-cols-2 2xl:grid-cols-4">
    <div class="card">
      ...
      <a href="#" class="px-5 py-3 text-sm font-medium text-purple-700 card-footer hover:text-black truncate">Income Reports</a>
    </div>
    <div class="card">
      <div class="p-5">
      ...
      <a href="#" class="px-5 py-3 text-sm font-medium text-purple-700 card-footer hover:text-black truncate">Expense Tracking</a>
    </div>
    <div class="card">
      <div class="p-5">
      ...
      <a href="#" class="px-5 py-3 text-sm font-medium text-purple-700 card-footer hover:text-black">View Invoices</a>
    </div>
    <div class="card">
      <div class="p-5">
      ...
      <a href="#" class="px-5 py-3 text-sm font-medium text-purple-700 card-footer hover:text-black truncate">Projection Report</a>
    </div>
  </div>
</section>
