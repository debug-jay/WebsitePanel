...
<div className=" flex justify-end">
    ...
    <div className='flex justify-center mt-5 border-t border-gray-700 pt-4'><img src={UserLogo} width={'40px'} alt="" className="rounded-full overflow-hidden shadow bg-gray-300" /><div>
        ...
        <ul class="space-y-2 mt-4 border-t border-gray-700 pt-4">
         ...
         <li id="li3">
            <Link to="/inbox" class="flex items-center p-2 text-base font-normal  rounded-lg text-white hover:bg-gray-700">
               ...
               <span class="ml-3 flex-1 whitespace-nowrap" id="query3">Inbox</span>
         ...
         <li id="li4">
            <Link to="/users" class="flex items-center p-2 text-base font-normal  rounded-lg text-white hover:bg-gray-700">
               <svg aria-hidden="true" class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clip-rule="evenodd"></path></svg>
               <span class="ml-3 flex-1 whitespace-nowrap" id="query4">Users</span>
            </Link>
         </li>
         <li id="li5">
            <Link to="/products" class="flex items-center p-2 text-base font-normal  rounded-lg text-white hover:bg-gray-700">
               ...
               <span class="ml-3 flex-1 whitespace-nowrap" id="query5">Products</span>
            </Link>
         </li>
         {/** Sign In List Item */}
         <li id="li6">
      ...
      <ul class="pt-4 mt-4 space-y-2 border-t border-gray-700 ">
         <li id="li7">
            <Link to="/team" class="flex items-center p-2 text-base font-normal  rounded-lg transition duration-75 hover:bg-gray-700 text-white group">
               ...
               <span class="ml-3 flex-1 whitespace-nowrap" id="query7">Team</span>
            </Link>
         </li>
         <li id="li8">
